...
--   at:        2021-09-02 05:40:44 AST
--   site:      Oracle Database 11g
--   type:      Oracle Database 11g

set echo on
SPOOL cust_order.txt
...
COMMENT ON COLUMN customer.cust_level IS
    'customer level: gold (g), silver (s), or bronze (b)';

COMMENT ON COLUMN customer.cust_dob IS
